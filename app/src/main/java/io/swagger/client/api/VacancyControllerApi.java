...
public class VacancyControllerApi {
    ...
    /**
     * Build call for getFilteredList
     * @param name  (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getFilteredListCall(String name, String industry, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFilteredListValidateBeforeCall(String name, String industry, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getFilteredListCall(name, industry, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Vacancy> getFilteredList(String name, String industry) throws ApiException {
        ApiResponse<List<Vacancy>> resp = getFilteredListWithHttpInfo(name, industry);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Vacancy>> getFilteredListWithHttpInfo(String name, String industry) throws ApiException {
        com.squareup.okhttp.Call call = getFilteredListValidateBeforeCall(name, industry, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getFilteredListAsync(String name, String industry, final ApiCallback<List<Vacancy>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getFilteredListValidateBeforeCall(name, industry, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Vacancy>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getList1Call(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getList1ValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getList1Call(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Vacancy> getList1() throws ApiException {
        ApiResponse<List<Vacancy>> resp = getList1WithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Vacancy>> getList1WithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getList1ValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<Vacancy>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getList1Async(final ApiCallback<List<Vacancy>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getList1ValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Vacancy>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
